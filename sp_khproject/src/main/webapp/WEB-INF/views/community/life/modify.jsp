...
<script type="text/javascript">
	function formCheck(form) {
		if (form.life_title.value === undefined
				|| form.life_title.value.trim() === "") {
							...
							<div class="feed-content">
								<div>
									...
									<section class="container">
										<div class="mt-3">
											<c:url var="lifeModifyUrl"
												value="/community/life/modify" />
											<form action="${lifeModifyUrl}" method="post">
												<input type="hidden" name="life_id"
													value="${data.life_Id}">
												<div class="mb-3">
													<input class="form-control" type="text"
														name="life_title" value="${data.life_Title}"
														placeholder="제목을 입력하세요.">
												</div>
												<div class="mb-3">
													<textarea class="form-control" name="life_content"
														rows="8" placeholder="내용을 입력하세요.">${data.life_Content}</textarea>
												</div>
