...
<script type="text/javascript">
	function formCheck(form) {
		if (form.findStu_title.value === undefined
				|| form.findStu_title.value.trim() === "") {
							...
							<div class="feed-content">
								<div>
									...
									<section class="container">
										<div class="mt-3">
											<c:url var="findStuModifyUrl"
												value="/community/findStu/modify" />
											<form action="${findStuModifyUrl}" method="post">
												<input type="hidden" name="findStu_id"
													value="${data.findStu_Id}">
												<div class="mb-3">
													<input class="form-control" type="text"
														name="findStu_title" value="${data.findStu_Title}"
														placeholder="제목을 입력하세요.">
												</div>
												<div class="mb-3">
													<textarea class="form-control" name="findStu_content"
														rows="8" placeholder="내용을 입력하세요.">${data.findStu_Content}</textarea>
												</div>
