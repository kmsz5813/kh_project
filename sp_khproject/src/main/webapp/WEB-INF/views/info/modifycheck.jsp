...
<body>
	...
	<section class="container w-75">
		...
		<div class="mb-3 find-btn">
			<button class="btn btn-primary find-btn1" onclick="location.href='/home/info/modify'" type="submit">확인</button>
			<button class="btn btn-secondary find-btn1" type="button" onclick="location.href='/home/info'">취소</button> 
		</div>
		</form>
	</section>
