...
@WebFilter(
		urlPatterns = {
				"/sellitem/additem"  // 추가로 넣어야할것??
		}
)
public class SellerAccountFilter extends HttpFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		if(session.getAttribute("loginData") != null && acdto.getAc_index() == 20) {
