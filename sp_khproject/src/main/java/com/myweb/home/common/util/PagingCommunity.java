...
public class PagingCommunity {
	 ...
	 private int curPage;  //현재 페이지 번호
	   ...
	   //총 게시글 수만 입력하는 생성자
	    public PagingCommunity(int totalCount) {
	    ...
	    public PagingCommunity(int totalCount,int curPage) {
	       setTotalCount(totalCount);
	       setCurPage(curPage);
	    ...
	    public PagingCommunity(int totalCount,int curPage,int listCount) {
	       setTotalCount(totalCount);
	       setCurPage(curPage);
	    ...
	    public PagingCommunity(int totalCount,int curPage,int listCount, int pageCount) {
	       setTotalCount(totalCount);
	       setCurPage(curPage);
	       setListCount(listCount);
