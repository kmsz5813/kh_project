...
DROP TABLE LIFE_COMMENT;
DROP TABLE FINDSTU_COMMENT;
DROP TABLE FINDPRO_COMMENT;
...
DROP SEQUENCE ISBUY_SEQ;
DROP SEQUENCE EVENTCOUPON_SEQ ;
DROP SEQUENCE SEL_ITEM_SEQ;
DROP SEQUENCE SEL_ITEM_STATICS_SEQ ;
DROP SEQUENCE FILE_UPLOAD_SEQ;
DROP SEQUENCE MESSAGE_SEQ;
DROP SEQUENCE NOTICE_SEQ;
DROP SEQUENCE QUESTION_SEQ;
DROP SEQUENCE QUESTION_STATICS_SEQ;
DROP SEQUENCE FINDSTU_SEQ;
DROP SEQUENCE FINDSTU_STATICS_SEQ;
DROP SEQUENCE FINDPRO_SEQ;
DROP SEQUENCE FINDPRO_STATICS_SEQ;
DROP SEQUENCE LIFE_SEQ;
DROP SEQUENCE LIFE_STATICS_SEQ;
DROP SEQUENCE QUESTION_COMMENT_SEQ;
DROP SEQUENCE LIFE_COMMENT_SEQ;
DROP SEQUENCE FINDSTU_COMMENT_SEQ;
DROP SEQUENCE FINDPRO_COMMENT_SEQ;
...
CREATE TABLE ACCOUNTS(
			...
			AC_INDEX NUMBER DEFAULT(10),		-- 일반회원 : 10  전문가 : 20,  관리자 : 30
...
DROP TABLE SEL_ITEM;				
SELECT * FROM SEL_ITEM;
SELECT COUNT(*) FROM SEL_ITEM WHERE SEL_ID = 58;
...
CREATE TABLE ISBUY(
			...
			BUY_FALSIFICATION VARCHAR2(2) 		-- 위,변조 여부 (변조했음면Y)
		);
