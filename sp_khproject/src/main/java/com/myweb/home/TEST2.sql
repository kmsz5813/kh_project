...
CREATE TABLE ISBUY(
			...
			BUY_BUYER VARCHAR2(20) NOT NULL,	-- 구매자
			BUY_SELLER VARCHAR2(20) NOT NULL,	-- 판매자
			...
			CONSTRAINT ISBUY_BUY_BUYER_FK FOREIGN KEY(BUY_BUYER) REFERENCES ACCOUNTS(AC_EMAIL),
			CONSTRAINT ISBUY_BUY_SELLER_FK FOREIGN KEY(BUY_SELLER) REFERENCES ACCOUNTS(AC_EMAIL)
		);
